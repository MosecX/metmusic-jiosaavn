...
This guide explains how to develop addons for the application. Addons are external HTTP servers that follow the MetMusic and Eclipse Music spec that allow developers to extend the application's capabilities by providing search results, metadata, lyrics, and library sync.
...
## 6. Library Sync API (MetMusic Specific)
