...
MetMusic is a high performance cross platform music player client designed for audiophiles. Built with Flutter, it delivers a native, responsive experience on both Windows and Android.

> [!NOTE]
> Note: MetMusic supports [EclipseMusic](https://eclipsemusic.app/addons) addons too, or any addon based player that uses the standard manifest format like stremio. Do check out [EclipseMusic](https://eclipsemusic.app/addons), it is frequently updated, addons are cross compatible.
...
1. Copy the repository:
   ```bash
   git clone https://github.com/MosecX/metmusic-app.git
   cd metmusic-app
   ```
...
## Disclaimer
MetMusic is solely a client side audio player that streams or locally plays audio from the user's own library. All rights belong to their respective owners.
