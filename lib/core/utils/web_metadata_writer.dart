...
class WebMetadataWriter {
  ...
  static Future<Uint8List> _injectMp4Metadata(Uint8List bytes, Track track, Dio dio) async {
    try {
      ...
      final udta = _buildAtom('udta', [
        _buildAtom('meta', [
          Uint8List(4),
          _buildAtom('hdlr', [Uint8List(8), Uint8List.fromList('mdirappl'.codeUnits), Uint8List(8), Uint8List.fromList('MetMusic\u0000'.codeUnits)]),
  ...
  static Uint8List _createVorbisCommentBlock(Track t) {
    ...
    final b = BytesBuilder(copy: false);
    b.add(Uint8List(4)..buffer.asByteData().setUint32(0, 8, Endian.little)); b.add(Uint8List.fromList('MetMusic'.codeUnits));
