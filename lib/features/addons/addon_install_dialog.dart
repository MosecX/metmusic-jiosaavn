      ...
      child: Column(
        ...
        children: [
          ...
          if (_previewManifest == null) ...[
            ...
            const SizedBox(height: 16),
            const Text(
              'Introduce la URL de un complemento compatible con Eclipse Music para instalarlo.',
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Instalado ${_previewManifest?.name}')),
        );
      }
    } catch (e) {
      if (mounted) {
